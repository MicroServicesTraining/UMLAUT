...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	static final String CLIEN_ID = "demo-client";
	...
	static final int REFRESH_TOKEN_VALIDITY_SECONDS = 1200;
	...
	public void configure(ClientDetailsServiceConfigurer configurer) throws Exception {
		configurer.inMemory().withClient(CLIEN_ID).secret(CLIENT_SECRET)
				.authorizedGrantTypes(AUTHORIZATION_CODE, REFRESH_TOKEN, GRANT_TYPE_PASSWORD, IMPLICIT)
